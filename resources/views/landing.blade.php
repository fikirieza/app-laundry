...
<head>
    ...
    <title>{{ config('app.name', 'Laundry Yuk') }}</title>
...
<body>
    ...
    <header class="bg-blue py-5">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/header.jpg')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/alat.jpg')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/tipebaju.jpg')}}" alt=""
                        srcset="">
                </div>
                <div class="col-lg-6">
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/pegawai.jpg')}}" alt=""
                        srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-md-6 mb-4 mb-sm-0">
                    <h5>Alamat</h5>
                    <p>Bumi Pakusarakan 2 Blok E1 No 05 RT 05 RW 23 Cidahu Desa Tanimulya Kecamatan Ngamprah Kabupaten Bandung Barat</p>
                    <br>
                    <h5>Kontak</h5>
                    <p>laundryyuk@gmail.com</p>
                    <p>(022)123456</p>
                    <p>08976524311</p>
                </div>
                <div class="col-md-6">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d247.58062959810098!2d107.53202990734023!3d-6.855793500000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e5a6ffff184d%3A0x6fe156e28c848358!2sBPS%202%20Blok%20E!5e0!3m2!1sid!2sid!4v1659407272036!5m2!1sid!2sid"
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Tugas PemWeb II Copyright &copy; {{config('app.name')}} 2022</p>
        </div>
        <!-- /.container -->
    </footer>
